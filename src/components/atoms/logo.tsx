...
const Base = styled.div<{width?: string, minWidth?: string, fill?: string, height: string}>`
...
const Logo: React.FC<LogoProps> = ({ width, minWidth, fill }) => {
  const height = 9/59*parseFloat(width || '270');
  return (
    <Base width={width} minWidth={minWidth} fill={fill} height={height+'px'}>
      <svg  viewBox="0 0 590 90">
        <title>Ryoga.exe</title>
        <desc>Ryoga.exe Logo</desc>
