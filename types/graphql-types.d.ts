...
export type BlogPostsIndexQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogPostsIndexQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { edges: Array<{ node: (
